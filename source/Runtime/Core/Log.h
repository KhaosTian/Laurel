...
#define LR_CORE_FATAL(...) SPDLOG_LOGGER_CRITICAL(::LR::Log::getCoreLogger(), __VA_ARGS__)

// Client log macros - 修改后
#define LR_TRACE(...) SPDLOG_LOGGER_TRACE(::LR::Log::getClientLogger(), __VA_ARGS__)
#define LR_INFO(...) SPDLOG_LOGGER_INFO(::LR::Log::getClientLogger(), __VA_ARGS__)
#define LR_WARN(...) SPDLOG_LOGGER_WARN(::LR::Log::getClientLogger(), __VA_ARGS__)
#define LR_ERROR(...) SPDLOG_LOGGER_ERROR(::LR::Log::getClientLogger(), __VA_ARGS__)
#define LR_FATAL(...) SPDLOG_LOGGER_CRITICAL(::LR::Log::getClientLogger(), __VA_ARGS__)
