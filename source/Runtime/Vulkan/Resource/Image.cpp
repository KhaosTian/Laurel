...
#include "Runtime/Vulkan/Command/CommandPool.h"
#include "Runtime/Vulkan/Resource/DepthBuffer.h"
#include "Runtime/Vulkan/Vulkan.h"
#include "Runtime/Vulkan/Resource/Buffer.h"
#include "Runtime/Vulkan/Resource/DeviceMemory.h"
#include "Runtime/Vulkan/Command/CommandBuffer.h"
#include <stdexcept>
#include "Runtime/Vulkan/Resource/Image.h"
...
Image::Image(const Device& device, VkExtent2D extent, uint32_t mip_level, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage):
    m_device(device),
    m_extent(extent),
    m_format(format),
